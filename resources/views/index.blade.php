...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/all.min.css') }}"> <!-- fontawesome -->
    <!-- <link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="{{asset('assets/css/tailwind.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/css/tooplate-antique-cafe.css') }}">
...
<body>
    <!-- Intro -->
    <div id="intro" class="parallax-window" data-parallax="scroll" data-image-src="{{ asset('assets/img/antique-cafe-bg-01.jpg') }}">
    ...
    <!-- Cafe Menu -->
    <div id="menu" class="parallax-window" data-parallax="scroll" data-image-src="{{ asset('assets/img/antique-cafe-bg-02.jpg') }}">
                ...
                <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    ...
                    @foreach ($dishes as $dish)
                        <div class="flex items-start mb-6 tm-menu-item">
                            <img src="{{ $dish->dish_image }}" alt="Image" class="rounded-md">
                            <div class="ml-3 sm:ml-6">
                                <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">{{ $dish->name }}</h3>
                                <div class="text-white text-md sm:text-lg font-light mb-1">Category : {{ $dish->category->name }}</div>
    ...
    <div id="about" class="parallax-window" data-parallax="scroll" data-image-src="{{ asset('assets/img/antique-cafe-bg-03.jpg') }}">
        <div class="container mx-auto tm-container py-24 sm:py-48">
    ...
    <div id="contact" class="parallax-window relative" data-parallax="scroll" data-image-src="{{ asset('assets/img/antique-cafe-bg-04.jpg') }}">
