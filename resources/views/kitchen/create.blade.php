        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header row d-flex  row align-items-center ">
                  <h3 class="card-title col-2 ">Create new dish</h3>
                ...
                <div class="card-body">
                    <form action="/dish" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="dish" aria-describedby="emailHelp" placeholder="Enter dish name">
                            @error('name')
